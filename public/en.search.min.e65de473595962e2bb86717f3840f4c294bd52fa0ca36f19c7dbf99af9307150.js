...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2d458328b5957afbabaf580c53ba632f6f7f90e52d7ee9640c1b84b21905a6fd.js',function(){input.required=false;search();});}
